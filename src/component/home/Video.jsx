...
const Video = () => {
  ...
  return(
    <div className="w-full lg:w-1/2 px-4">
      <div>
        <div className="relative h-64 sm:h-72 md:h-80 lg:h-[350px] overflow-hidden rounded-sm ">
          <div className="absolute top-0 left-0 h-full w-full">
            <img src={image} alt="video" className="h-full w-full object-cover object-center"/>
          </div>
          <div className="absolute top-0 left-0 flex h-full w-full items-center justify-center bg-darkblue bg-opacity-80">
            <button onClick={toggle} className="absolute z-10 flex h-20 w-20 items-center justify-center rounded-full bg-white text-midnight md:h-[100px] md:w-[100px]">
      ...
      <div className="fixed top-0 left-0 z-50 h-screen w-full hidden items-center justify-center bg-black bg-opacity-70">
        ...
        <button className="absolute top-0 right-0 flex h-20 w-20 cursor-pointer items-center justify-center text-body-color hover:bg-black" >
